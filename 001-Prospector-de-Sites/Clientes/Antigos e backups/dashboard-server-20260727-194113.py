...
CAMPOS = ['slug','nome','nicho','cidade','nota','avaliacoes','email','telefone','whatsapp',
          ...
          'instagram','gmnUrl','gmnCid','dominio','razaoSocial','responsavel','diaVencimento','valorTrimestral']
...
def conexao():
    ...
    for col, tipo in [('contratoStatus',"TEXT DEFAULT 'pendente'"),('contratoEm','TEXT'),('manutencao','REAL'),('pago','INTEGER DEFAULT 0'),('docCliente','TEXT'),('endCliente','TEXT'),('instagram','TEXT'),('gmnUrl','TEXT'),('gmnCid','TEXT'),('dominio','TEXT'),('razaoSocial','TEXT'),('responsavel','TEXT'),('diaVencimento','INTEGER'),('valorTrimestral','REAL')]:
